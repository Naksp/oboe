...
SampleSource* SimpleMultiPlayer::getSampleSource(int32_t index) {
    return mSampleSources.at(index);
}

SampleBuffer* SimpleMultiPlayer::getSampleBuffer(int32_t index) {
    return mSampleBuffers.at(index);
}
